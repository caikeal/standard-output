...
class Factory
{
     ...
     * @return void
     */
    public function error($message, $statusCode, $code = 0)
    {
     ...
     * @return void
     */
    public function errorNotFound($message = 'Not Found', $code = 0)
    {
        $this->error($message, 404, $code);
    }
     ...
     * @return void
     */
    public function errorBadRequest($message = 'Bad Request', $code = 0)
    {
        $this->error($message, 400, $code);
    }
     ...
     * @return void
     */
    public function errorForbidden($message = 'Forbidden', $code = 0)
    {
        $this->error($message, 403, $code);
    }
     ...
     * @return void
     */
    public function errorInternal($message = 'Internal Error', $code = 0)
    {
        $this->error($message, 500, $code);
    }
     ...
     * @return void
     */
    public function errorUnauthorized($message = 'Unauthorized', $code = 0)
    {
        $this->error($message, 401, $code);
    }
     ...
     * @return void
     */
    public function errorMethodNotAllowed($message = 'Method Not Allowed', $code = 0)
    {
        $this->error($message, 405, $code);
    }
